...
/**
 * Servlet implementation class ES_login
 */
@WebServlet("/ES_login")
public class ES_login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String qur="select * from es_register where email=? and pass=?";
			...
			if(rs.next()) {
				out.print("<html><body><script>alert('Estimate Team Login Successfully') </script></body></html>");
