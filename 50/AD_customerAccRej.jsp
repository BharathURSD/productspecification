...
<html lang="en">
  <head>
  	<title>Admin Check Product</title>
    <meta charset="utf-8">
...
background-size: 1500px 910px;
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4" style='background-color:white;width:300px;font-family:normal;margin-left:40%;'>PRODUCT STATUS </h4>
					<h6 class="h5 mb-4 text-center"><a  href="AD_homepg.html" class="button" style='font-family:normal;'>HOME</a></h6>
					<div class="table-wrap" style="height:520px;overflow:auto;">
					<div class="tableFixHead" >
					    ...
					    <tbody>
					      <tr Style='background-color:green'>
						      ...
						      <form action="AD_pattern.jsp"  method="post">  
						      ...
						      <input  type="hidden" name="length" value="<%=rs1.getString(7) %>" >
						       <input  type="hidden" name="width" value="<%=rs1.getString(8) %>" >
						        ...
						        <input  type="hidden" name="thick" value="<%=rs1.getString(10) %>" >
						        <input  type="hidden" name="inndia" value="<%=rs1.getString(11) %>" >
						        <input  type="hidden" name="outdia" value="<%=rs1.getString(12) %>" >						        
						         <input  type="hidden" name="opr" value="<%=rs1.getString(15) %>" >
						      <input type="submit" style='background-color:DodgerBlue;font-family:normal;' value="CLICK" class="button">   
						      </form>
						      </td> 
					      </tr>
