...
background-size: 1500px 910px;
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4" style='background-color:white;font-family:normal;margin-left:5%;width:300px;margin-left:38%;'>COMPLETE PRODUCT</h4>
					    ...
					    <tbody>
					      <tr>
						      ...
						      <td><%=rs1.getString(11) %></td>
						       ...
						       <td>	
						      <form action="AD_approveproduct.jsp"  method="post">  
						      ...
						      <button class="button"  value="approved" name="status" style='font-family:normal;padding:8px 8px;'>UPDATE</button>
