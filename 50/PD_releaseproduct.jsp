...
<html lang="en">
  <head>
  	<title>Production Deployed</title>
    <meta charset="utf-8">
...
background-size: 1500px 900px;
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4" style='background-color:white;width:300px;font-family:normal;margin-left:36%;font-family:normal;margin-left:36%'>DEPLOY PRODUCT</h4>
