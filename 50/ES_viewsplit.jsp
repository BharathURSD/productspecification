...
<html lang="en">
  <head>
  	<title>View Balance Product</title>
    <meta charset="utf-8">
...
background-size: 1500px 910px;
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h4 class="text-center mb-4" style='background-color:white;width:300px;font-family:normal;margin-left:37%;'> VIEW PREDICTION</h4>
				...
				<%-- <br><label style='background-color:yellow'>Totalcount:</label> 
				<%=Totalcount %>
			</div>
			<br><center><th><a href="ES_calculateAcc"> <button style='background-color:yellow'>AMOUNT CHECKING</button></a></th></center> --%>
		</div>
	</section>
